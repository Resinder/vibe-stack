...
export class PlanningController {
  ...
  async generatePlan(args) {
    try {
      // Validate inputs
      const goal = PlanningValidator.validateGoal(args.goal);
      const context = PlanningValidator.validateContext(args.context);
      const targetLane = args.targetLane ? TaskValidator.validateLane(args.targetLane) : 'backlog';
